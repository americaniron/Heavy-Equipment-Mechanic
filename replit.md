...
- `server/services/avatar.ts` - HeyGen LiveAvatar API integration with Contexts (context_id-based personas, opening_text auto-greetings, H264/high quality, session create/start/stop)
